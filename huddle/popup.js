// UNIFIED POPUP.JS - With Auto-Save to Downloads
...
function showFeaturesUI() {
    ...
    updateTheme('default');
    updateStatus("Open Google Meet, Teams, Zoom, or Google Chat to start recording (auto-saves to Downloads when done)", "info");
